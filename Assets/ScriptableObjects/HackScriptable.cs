...
public abstract class HackScriptable<T0> : HackScriptable
{
    ...
    [SerializeField] protected List<HackVariator<T0>> hackVariators = new List<HackVariator<T0>>();

    public List<HackVariator<T0>> HackVariators { get { return hackVariators; } }
...
public abstract class HackScriptable<T0, T1, T2> : HackScriptable
{


    [SerializeField] protected T0 param1 = default(T0);
    [SerializeField] protected T1 param2 = default(T1);
    [SerializeField] protected T2 param3 = default(T2);

    public override void Execute()
    {
        HackFunction(param1, param2, param3);
    }

    public virtual void SetParams(T0 arg1, T1 arg2, T2 arg3)
    {
        param1 = arg1;
        param2 = arg2;
        param3 = arg3;
    ...
    protected abstract void HackFunction(T0 arg1, T1 arg2, T2 arg3);
}

[Serializable]
public struct HackVariator<T0>
{
    public T0 param1;
}

[Serializable]
public struct HackVariator<T0, T1>
{
    public T0 param1;
    public T1 param2;
}
...
[Serializable]
public struct HackVariator<T0, T1, T2>
{
    public T0 param1;
    public T1 param2;
    public T2 param3;
